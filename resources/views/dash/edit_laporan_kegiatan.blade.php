    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Edit Laporan kegiatan</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title m-t-0">Edit Laporan kegiatan</h4>
                    <p class="text-muted font-14">

                    
                    <div class="tab-content">
                        <div class="tab-pane show active" id="file-upload-preview">
                            <form name="form_upload_edit" action="{{url('/ubah_laporan_kegiatan/'.$id)}}" method="post" enctype="multipart/form-data" class="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                                {{-- <div class="fallback">
                                ...
                                <div class="dz-message needsclick">
                                <p class="bor-file" style="word-break: break-word; "><span id="dokumen_lht">{{$kegiatan->file_kegiatan}}</span> </p>
                                </div>
                        </div> <!-- end preview-->
                    </div> <!-- end tab-content-->
                    ...
                    <div class="mb-3" style="margin-top:40px">
                      ...
                      <h4 class="header-title m-t-0">Nama berkas laporan kegiatan</h4>
                      <input type="text" id="nf_laporan" value="{{$kegiatan->nama_file}}" name="nama_file" class="form-control" placeholder="Nama berkas Laporan" style="border: 1px solid rgb(161, 161, 161);">
...
@section('script')
   ...
   ></script>
    ...
    <script>
        $(function(){
            $('input[name=file_kegiatan]').change(function(){
        ...
        $(function() {
          $("form[name='form_upload_edit']").validate({
            ...
            messages: {
                nama_file: "<span style='color: red;'>Nama berkas tidak boleh kosong</span>",
            },
